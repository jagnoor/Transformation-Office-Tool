...
PALETTES = {
    "Ocean": [
        "#0077B6", "#00B4D8", "#0096C7", "#023E8A", "#0E7490",
        "#0369A1", "#1D4ED8", "#03045E", "#0891B2", "#0077B6",
    ],
    "Sunset": [
    ...
    "Forest": [
        "#2D6A4F", "#40916C", "#52B788", "#15803D", "#047857",
        "#1B4332", "#166534", "#065F46", "#081C15", "#3A5A40",
    ],
    "Corporate": [
    ...
    "Monochrome": [
        "#1E293B", "#334155", "#475569", "#64748B", "#4B5563",
        "#6B7280", "#0F172A", "#374151", "#525D6B", "#4A5568",
    ],
}
